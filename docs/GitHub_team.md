...
Проверить, что PR проходит CI(линтер и тесты). Если CI прошел успешно, то нужно запросить от меня ревью и дождаться пока я его сделаю. Дальше нужно дойти до момента, когда проверяющему понравится pr и он заапрувит его.
